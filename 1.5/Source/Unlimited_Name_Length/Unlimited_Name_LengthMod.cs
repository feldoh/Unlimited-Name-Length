...
public static class GiveNameLengthPatch
{
    ...
    public static IEnumerable<Type> GetAllConcreteDialogRenameSubclasses()
    {
        var baseType = typeof(Dialog_Rename<>);
    ...
    public static IEnumerable<MethodBase> TargetMethods()
    {
        ...
        foreach (var type in GetAllConcreteDialogRenameSubclasses())
        {
            yield return AccessTools.PropertyGetter(type, "MaxNameLength");
        }
    }
